...
public class GeocodeResponse {
	 ...
	 * 
	 * @param jsonGeocodeResponse
	 *            Geocoding find response in the JSON format.
	 * @return an instance of GResponse containing the information from the JSON
	 *         response.
	 */
	public static GResponse parse(String jsonGeocodeResponse) {
		GResponse responseAsObjects = new Gson().fromJson(jsonGeocodeResponse, GResponse.class);
