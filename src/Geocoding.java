...
/**
 * Provides methods useful for the My Favorite Places project. Methods include:
 * - find: to obtain latitude and longitude for an address utilizing Google's
 * Geocoding API. - distance: to determine the distance between 2 points on the
 * Earth's surface. - openBrowser: to open a browser at a specified URL.
 * 
 * @See https://developers.google.com/maps/documentation/geocoding/intro#
 *      Geocoding
 * 
 *      Adapted from Stuart Reges' GeoLocator project (University of
 *      Washington).
 */
public class Geocoding {
	 ...
	 * address. The GeocodeResponse class contains methods to parse the JSON
	 ...
	 * 
	 * @param url
	 *            A url such as https://www.google.com/maps/
	 * @throws IOException
	...
	/**
	 * This main method had code demonstrating how to use the various methods in
	 * Geocoding.java and GeocodeResponse.java files.
	 * 
	 * @param args
	 *            unused
	 */
	public static void main(String[] args) {
		...
		try {
			...
			openBrowser(
					"https://www.google.com/maps/place/2+E+Main+St%2C+Madison%2C+WI+53703%2C+USA/@43.074691,-89.3841678,17z/");
